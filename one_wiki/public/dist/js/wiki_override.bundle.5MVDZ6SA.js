(() => {
  // ../one_wiki/one_wiki/public/js/edit_asset.js
  window.EditAsset = class EditAsset {
    ...
    build_attachment_table() {
      ...
      const caption = (file_url) => file_url.split("/").pop().split(".").slice(0, -1).join(".").replaceAll("_", " ").replaceAll("-", " ");
    ...
    raise_patch(draft = false) {
      ...
      $('.doc-sidebar [data-type="Wiki Sidebar"]').each(function() {
        let name2 = $(this).get(0).dataset.groupName;
        side[name2] = [];
        let items2 = $(this).children("ul").children("li");
        items2.each((item) => {
          if (!items2[item].dataset.name)
            return;
          side[name2].push({
            name: items2[item].dataset.name,
            type: items2[item].dataset.type,
            new: items2[item].dataset.new,
            title: items2[item].dataset.title,
            group_name: items2[item].dataset.groupName
          });
        });
      });
      var me = this;
    ...
    render_preview() {
      $('a[data-toggle="tab"]').on("click", (e) => {
        ...
        if (activeTab.prop("id") === "preview-tab" || activeTab.prop("id") === "diff-tab") {
    ...
    display_new_comment(comment, comment_box) {
      if (comment) {
        ...
        const new_comment = this.get_comment_html(comment.owner, comment.creation, comment.timepassed, comment.content);
      ...
      for (let sidebar in sidebar_items) {
        for (let item in sidebar_items[sidebar]) {
          ...
          if (sidebar_items[sidebar][item].type == "Wiki Sidebar") {
            $(target).append("<li>" + sidebar_items[sidebar][item].title + "</li><ul class=" + sidebar_items[sidebar][item].group_name + "></ul>");
          } else {
            $(target).append("<li class=" + sidebar_items[sidebar][item].group_name + ">" + sidebar_items[sidebar][item].title + "</li>");
          }
        }
      }
    }
  ...
  // ../one_wiki/one_wiki/public/js/edit_wiki.js
  window.EditWiki = class EditWiki extends Wiki {
    constructor() {
      super();
      frappe.provide("frappe.ui.keys");
      $("document").ready(() => {
        frappe.call("wiki.wiki.doctype.wiki_page.wiki_page.get_sidebar_for_page", {
    ...
    set_add_item() {
      $(`<div class="text-muted add-sidebar-item small">+ Add Item</div>
			<div class="text-muted small mt-3"><i>Drag items to re-order</i></div>`).appendTo($(".web-sidebar"));
      var me = this;
    ...
    add_wiki_page(fields) {
      ...
      frappe.call({
        ...
        callback: function(r) {
          ...
          $new_page.appendTo($(".doc-sidebar .sidebar-items").children(".list-unstyled").not(".hidden").first());
        }
      });
    }
  ...
  // ../one_wiki/one_wiki/public/js/render_wiki.js
  window.RenderWiki = class RenderWiki extends Wiki {
    constructor(opts) {
      super();
      $("document").ready(() => {
        if (window.location.pathname != "/revisions" && window.location.pathname != "/compare") {
          this.activate_sidebars();
          this.set_active_sidebar();
    ...
    set_toc_highlighter() {
      $(document).ready(function() {
        $(window).scroll(function() {
          if (currentAnchor().not(".no-underline").hasClass("active"))
            return;
  ...
  // ../one_wiki/one_wiki/public/js/edit_wiki_ar.js
  window.EditWikiAr = class EditWikiAr extends Wiki {
    ...
    set_add_item() {
      $(`<div class="text-muted add-sidebar-item small">+ \u0627\u0636\u0627\u0641\u0629 \u0639\u0646\u0635\u0631 </div>
			<div class="text-muted small mt-3"><i>\u0627\u0633\u062D\u0628 \u0627\u0644\u0639\u0646\u0627\u0635\u0631 \u0644\u0625\u0639\u0627\u062F\u0629 \u062A\u0631\u062A\u064A\u0628\u0647\u0627 </i></div>`).appendTo($(".web-sidebar"));
      var me = this;
      $(".add-sidebar-item").click(function() {
        var dfs = me.get_add_new_item_dialog_fields();
        var dialog = new frappe.ui.Dialog({
  ...
  // ../one_wiki/one_wiki/public/js/edit_asset_ar.js
  window.EditAssetAr = class EditAssetAr {
    ...
    raise_patch(draft = false) {
      ...
      dfs.push({
        ...
        fieldtype: "Text",
        label: "Message",
        default: $('[name="new"]').val() ? `Add new page: ${title_of_page}` : `${title_of_page} \u062A\u0645 \u062A\u062D\u0631\u064A\u0631\u0647`,
        mandatory: 1
      }, {
        fieldname: "sidebar_edited",
        fieldtype: "Check",
        ...
        primary_action: function() {
          frappe.call({
            ...
            callback: (r) => {
              if (!r.message.approved && r.message.route == "contributions") {
                frappe.msgprint({
                  message: "\u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0637\u0644\u0628 \u062A\u063A\u064A\u064A\u0631. \u064A\u0645\u0643\u0646\u0643 \u062A\u062A\u0628\u0639 \u0637\u0644\u0628\u0627\u062A\u0643 \u0639\u0644\u0649 \u0635\u0641\u062D\u0629 \u0627\u0644\u0645\u0633\u0627\u0647\u0645\u0627\u062A",
                  indicator: "green",
    ...
    set_listeners() {
      ...
      $(`body`).on("click", `.delete-button`, function() {
        frappe.confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0623\u0646\u0643 \u062A\u0631\u064A\u062F \u062D\u0630\u0641 \u0627\u0644\u0645\u0644\u0641 "${$(this).attr("data-name")}"`, () => {
          me.attachments.forEach((f, index, object) => {
            if (f.file_name == $(this).attr("data-name")) {
              object.splice(index, 1);
            }
...
//# sourceMappingURL=wiki_override.bundle.5MVDZ6SA.js.map
